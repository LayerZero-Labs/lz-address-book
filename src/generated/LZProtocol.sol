...
contract LZProtocol is ILZProtocol {
    ...
    function _registerAllChains() private {
        ...
        _registerChain(
            LayerZeroV2AultTestnet.EID,
            address(LayerZeroV2AultTestnet.ENDPOINT_V2),
            address(LayerZeroV2AultTestnet.SEND_ULN_302),
            address(LayerZeroV2AultTestnet.RECEIVE_ULN_302),
            LayerZeroV2AultTestnet.BLOCKED_MESSAGE_LIB,
            LayerZeroV2AultTestnet.EXECUTOR,
            LayerZeroV2AultTestnet.CHAIN_ID,
            "ault-testnet",
            new string[](0)
        );
        _registerChain(
        ...
        _registerChain(
            LayerZeroV2GensynTestnet.EID,
            address(LayerZeroV2GensynTestnet.ENDPOINT_V2),
            address(LayerZeroV2GensynTestnet.SEND_ULN_302),
            address(LayerZeroV2GensynTestnet.RECEIVE_ULN_302),
            LayerZeroV2GensynTestnet.BLOCKED_MESSAGE_LIB,
            LayerZeroV2GensynTestnet.EXECUTOR,
            LayerZeroV2GensynTestnet.CHAIN_ID,
            "gensyn-testnet",
            new string[](0)
        );
        _registerChain(
        ...
        _registerChain(
            LayerZeroV2HoodiTestnet.EID,
            address(LayerZeroV2HoodiTestnet.ENDPOINT_V2),
            address(LayerZeroV2HoodiTestnet.SEND_ULN_302),
            address(LayerZeroV2HoodiTestnet.RECEIVE_ULN_302),
            LayerZeroV2HoodiTestnet.BLOCKED_MESSAGE_LIB,
            LayerZeroV2HoodiTestnet.EXECUTOR,
            LayerZeroV2HoodiTestnet.CHAIN_ID,
            "hoodi-testnet",
            new string[](0)
        );
        _registerChain(
