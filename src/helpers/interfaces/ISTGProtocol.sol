...
/// @dev All Stargate contracts (StargatePool and StargateOFT) implement the IOFT interface
interface ISTGProtocol {
    ...
    /// @notice Get a Stargate asset by chain name and symbol
    /// @param chainName The Stargate chain name (e.g., "arbitrum", "base", "bera")
    /// @param symbol The asset symbol (e.g., "USDC", "USDC.e", "ETH")
    ...
    /// @notice Get all Stargate assets on a chain by name
    /// @param chainName The Stargate chain name
    /// @return assets Array of all Stargate assets on the chain
    function getAssetsForChain(string memory chainName) external view returns (StargateAsset[] memory assets);
    
    /// @notice Get TokenMessaging address for a chain by name
    /// @param chainName The Stargate chain name
    ...
    /// @notice Get a Stargate asset by LayerZero EID and symbol
    ...
    /// @notice Get all Stargate assets on a chain by EID
    /// @param eid The LayerZero endpoint ID
    /// @return assets Array of all Stargate assets on the chain
    function getAssetsForEid(uint32 eid) external view returns (StargateAsset[] memory assets);
    
    /// @notice Get TokenMessaging address for a chain by EID
    /// @param eid The LayerZero endpoint ID
    /// @return tokenMessaging The TokenMessaging contract address
    ...
    /// @notice Get a Stargate asset by native chain ID and symbol
    ...
    /// @notice Get all Stargate assets on a chain by chain ID
    ...
    /// @notice Get TokenMessaging address for a chain by chain ID
    /// @param chainId The native chain ID
    /// @return tokenMessaging The TokenMessaging contract address
    ...
    /// @notice Get Stargate chain name from LayerZero EID
    /// @param eid The LayerZero endpoint ID
    ...
    /// @notice Get Stargate chain name from native chain ID
    /// @param chainId The native chain ID
    /// @return chainName The Stargate chain name
    ...
    /// @return chains Array of all chain names with Stargate deployments
    function getSupportedChains() external view returns (string[] memory chains);
    
    /// @notice Check if a chain has StargateOFT (Hydra) for a symbol
    /// @param chainName The Stargate chain name
    /// @param symbol The asset symbol
    ...
    /// @notice Check if an asset exists on a chain by name
    /// @param chainName The Stargate chain name
    /// @param symbol The asset symbol
    ...
    /// @notice Check if a native chain ID is supported by Stargate
    /// @param chainId The native chain ID
